...
<!-- Modal -->
<div class="modal fade" id="tb_login" tabindex="-1" aria-labelledby="tb_loginLabel" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			<div class="modal-body">
				<div class="jconfirm-title-c">
					<span class="jconfirm-title">Thông báo</span>
				</div>
				<div class="jconfirm-content-pane">
					<span>Bạn chưa đăng nhập, vui lòng đăng nhập để mua khóa học của chúng tôi?</span>
				</div>
				<div class="dangnhap_ngay">
					<a href="account/dang-nhap">Đăng nhập ngay</a>
				</div>
			</div>
		</div>
	</div>
