                                    ...
                                    <div class="tab-content" id="custom-tabs-three-tabContent-lang">
                                        <?php foreach ($config['website']['lang'] as $k => $v) { ?>
                                            <div class="tab-pane fade show <?= ($k == 'vi') ? 'active' : '' ?>" id="tabs-lang-<?= $k ?>" role="tabpanel" aria-labelledby="tabs-lang">
                                                ...
                                                <?php if (isset($config['product'][$type]['link_video_brand']) && $config['product'][$type]['link_video_brand'] == true && $k == 'vi') { ?>
                                                    <div class="form-group">
                        ...
                        <div class="card-body">
                            <div class="form-group-category">
                                <?php if (isset($config['product'][$type]['khoahoc']) && $config['product'][$type]['khoahoc'] == true) { ?>
                                    <div class="form-group mb-2"><?= $func->get_khoahoc('product', '', $type) ?></div>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
