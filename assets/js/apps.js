...
NN_FRAMEWORK.FixMenu = function () {
  $(window).scroll(function () {
    ...
    if ($(window).scrollTop() >= hei + 20)
      $(".header-height").addClass("fixed");
...
NN_FRAMEWORK.Cart = function () {
  $(".addcart").click(function () {
    var mau = $(".color-pro-detail.active").data("idmau")
      ? $(".color-pro-detail.active").data("idmau")
      : 0;
    var size = $(".size-pro-detail.active").data("idsize")
      ? $(".size-pro-detail.active").data("idsize")
      : 0;
    var id = $(this).data("id");
  ...
  if ($(".heart").exists()) {
    $(".heart").click(function () {
      ...
      var yeuthich = $(this).data("yeuthich");
      ...
      $.ajax({
        ...
        type: "POST",
        dataType: "html",
        data: { yeuthich: yeuthich, idpro: idpro, id_user: id_user },
        success: function (result) {
        },
      });
    });
  ...
  if ($(".check_thongbao").exists()) {
    $(".check_thongbao").click(function () {
      var id = $(this).data("id");
      var check = $(this).data("check");
      
      $.ajax({
        url: "ajax/ajax_thongbao.php",
        type: "POST",
        dataType: "html",
