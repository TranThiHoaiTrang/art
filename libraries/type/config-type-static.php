...
$config['static'][$nametype]['motangan'] = false;
...
/* Giới thiệu */
$nametype = "banner_trangchu";
$config['static'][$nametype]['title_main'] = "Banner trang chủ";
$config['static'][$nametype]['images'] = true;
...
// /* Footer */
$nametype = "hethongphancap";
$config['static'][$nametype]['title_main'] = "Hệ thống phân cấp";
$config['static'][$nametype]['tieude'] = true;
$config['static'][$nametype]['noidung'] = true;
$config['static'][$nametype]['noidung_cke'] = true;

// /* Footer */
$nametype = "text_cachthuchoc";
$config['static'][$nametype]['title_main'] = "Text cách thức học";
...
// /* Footer */
$nametype = "text-lsht";
$config['static'][$nametype]['title_main'] = "Text lịch sử hình thành";
$config['static'][$nametype]['tieude'] = true;
$config['static'][$nametype]['mota'] = false;
$config['static'][$nametype]['mota_cke'] = true;
$config['static'][$nametype]['noidung'] = true;
...
// /* Footer */
$nametype = "text-giaithuong";
$config['static'][$nametype]['title_main'] = "Text giải thưởng";
$config['static'][$nametype]['tieude'] = true;
$config['static'][$nametype]['mota'] = false;
$config['static'][$nametype]['mota_cke'] = true;
$config['static'][$nametype]['noidung'] = true;
