...
$config['photo']['photo_static'][$nametype]['images'] = true;
$config['photo']['photo_static'][$nametype]['width'] = 212;
$config['photo']['photo_static'][$nametype]['height'] = 100;
$config['photo']['photo_static'][$nametype]['thumb'] = '212x100x2';
$config['photo']['photo_static'][$nametype]['img_type'] = '.jpg|.gif|.png|.jpeg|.gif|.JPG|.PNG|.JPEG|.Png|.GIF';
...
$config['photo']['man_photo'][$nametype]['tieude_photo'] = false;
$config['photo']['man_photo'][$nametype]['mota_photo'] = true;
$config['photo']['man_photo'][$nametype]['mota_cke_photo'] = true;
$config['photo']['man_photo'][$nametype]['width_photo'] = 1500;
...
/* Slideshow */
$nametype = "slide-mobile";
$config['photo']['man_photo'][$nametype]['title_main_photo'] = "Slideshow mobile";
$config['photo']['man_photo'][$nametype]['number_photo'] = 1;
$config['photo']['man_photo'][$nametype]['images_photo'] = true;
$config['photo']['man_photo'][$nametype]['avatar_photo'] = true;
$config['photo']['man_photo'][$nametype]['link_photo'] = true;
...
/* Slideshow */
$nametype = "banner-home";
$config['photo']['man_photo'][$nametype]['title_main_photo'] = "Banner home";
$config['photo']['man_photo'][$nametype]['number_photo'] = 1;
$config['photo']['man_photo'][$nametype]['images_photo'] = true;
$config['photo']['man_photo'][$nametype]['avatar_photo'] = true;
$config['photo']['man_photo'][$nametype]['link_photo'] = true;
...
/* Slideshow */
$nametype = "banner-khoahoc";
$config['photo']['man_photo'][$nametype]['title_main_photo'] = "Banner khóa học";
$config['photo']['man_photo'][$nametype]['number_photo'] = 1;
$config['photo']['man_photo'][$nametype]['images_photo'] = true;
$config['photo']['man_photo'][$nametype]['avatar_photo'] = true;
$config['photo']['man_photo'][$nametype]['link_photo'] = false;
...
/* Background */
$nametype = "banner-right-sp";
$config['photo']['photo_static'][$nametype]['title_main'] = "Banner right sản phẩm";
$config['photo']['photo_static'][$nametype]['images'] = true;
