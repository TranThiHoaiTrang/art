...
/* Sản phẩm */
$nametype = "san-pham";
$config['product'][$nametype]['title_main'] = "Khóa học";
...
$config['product'][$nametype]['giangvien'] = true;
$config['product'][$nametype]['datduoc'] = true;
...
$config['product'][$nametype]['check'] = array("noibat" => "Nổi bật","hot" => "Yêu thích");
...
$config['product'][$nametype]['amthanh'] = true;
$config['product'][$nametype]['congcu'] = true;
$config['product'][$nametype]['dichvu'] = true;
$config['product'][$nametype]['videobaigiang'] = true;
$config['product'][$nametype]['thoigianhoc'] = true;
$config['product'][$nametype]['thanhpham'] = true;
$config['product'][$nametype]['link_video'] = true;
$config['product'][$nametype]['chuongtrinhhoc'] = true;
$config['product'][$nametype]['chuongtrinhhoc_cke'] = true;
...
$config['product'][$nametype]['motangan_list'] = false;
...
$config['product'][$nametype]['link_video_cat'] = true;
...
$config['product'][$nametype]['mota_cke_cat'] = true;
...
/* Sản phẩm (Hãng) */
$config['product'][$nametype]['title_main_brand'] = "Chương khóa học";
$config['product'][$nametype]['images_brand'] = true;
$config['product'][$nametype]['show_images_brand'] = false;
$config['product'][$nametype]['khoahoc'] = true;
$config['product'][$nametype]['link_video_brand'] = true;
...
/* Sản phẩm (Hãng) */
$config['product'][$nametype]['title_main_doday'] = "Bài khóa học";
$config['product'][$nametype]['images_doday'] = true;
$config['product'][$nametype]['show_images_doday'] = false;
$config['product'][$nametype]['khoahoc'] = true;
$config['product'][$nametype]['link_video_doday'] = true;
$config['product'][$nametype]['thoiluong_video_doday'] = true;
$config['product'][$nametype]['slug_doday'] = true;
$config['product'][$nametype]['check_doday'] = array("check_lock" => "Mở khóa");
...
$config['product'][$nametype]['width_doday'] = 150;
$config['product'][$nametype]['height_doday'] = 150;
$config['product'][$nametype]['thumb_doday'] = '100x100x1';
$config['product'][$nametype]['img_type_doday'] = '.jpg|.gif|.png|.jpeg|.gif|.JPG|.PNG|.JPEG|.Png|.GIF';

// /* Sản phẩm (Cat) */
// $config['product'][$nametype]['title_main_danhmuc'] = "Danh mục";
// $config['product'][$nametype]['images_danhmuc'] = true;
// $config['product'][$nametype]['show_images_danhmuc'] = true;
...
//     ),
// );
// $config['product'][$nametype]['check_danhmuc'] = array();
// $config['product'][$nametype]['mota_danhmuc'] = false;
// $config['product'][$nametype]['mota_cke_danhmuc'] = false;
...
// /* Sản phẩm (Cat) */
// $config['product'][$nametype]['title_main_danhmuc_cap'] = "Danh mục cấp";
